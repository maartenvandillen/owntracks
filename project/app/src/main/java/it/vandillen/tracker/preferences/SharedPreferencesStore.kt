...
import it.vandillen.tracker.ui.preferences.ConnectionFragment
import it.vandillen.tracker.ui.preferences.PreferencesActivity
import it.vandillen.tracker.ui.preferences.PreferencesActivity.Companion.START_FRAGMENT_KEY
...
constructor(
  ...
  private fun migrateToSingleSharedPreferences() {
    val oldSharedPreferenceNames =
        listOf(
            "it.vandillen.tracker.preferences.private", "it.vandillen.tracker.preferences.http")
