...
import it.vandillen.tracker.model.messages.AddMessageStatus
import it.vandillen.tracker.model.messages.MessageLocation
import it.vandillen.tracker.model.messages.MessageLocation.Companion.fromLocation
import it.vandillen.tracker.model.messages.MessageLocation.Companion.fromLocationAndWifiInfo
...
import it.vandillen.tracker.model.messages.MessageWaypoints
import it.vandillen.tracker.net.WifiInfoProvider
  ...
  suspend fun publishWaypointsMessage() {
    messageProcessor.queueMessageForSending(
        MessageWaypoints().apply {
          waypoints =
              it.vandillen.tracker.support.MessageWaypointCollection().apply {
