...
import it.vandillen.tracker.model.messages.MessageEncrypted
import it.vandillen.tracker.model.messages.MessageUnknown

@Singleton
class Parser @Inject constructor(private val encryptionProvider: it.vandillen.tracker.model.EncryptionProvider?) {
