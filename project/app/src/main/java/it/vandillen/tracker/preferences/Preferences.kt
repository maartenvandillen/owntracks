...
import it.vandillen.tracker.BuildConfig
import it.vandillen.tracker.location.LocatorPriority
import it.vandillen.tracker.model.messages.MessageConfiguration
...
constructor(
  ...
  private val firestoreExportedConfigKeys =
      allConfigKeys.filter { property ->
        property.annotations.any { annotation ->
          annotation is Preference && annotation.exportModeFirestore
        }
      }
  ...
  @Preference(exportModeMqtt = true) var cleanSession: Boolean by preferencesStore

  @Preference(exportModeMqtt = true) var clientId: String by preferencesStore
  ...
  @Preference(exportModeHttp = true) var dontReuseHttpClient: Boolean by preferencesStore
  ...
  @Preference(exportModeMqtt = true) var host: String by preferencesStore
  ...
  @Preference(exportModeMqtt = true) var info: Boolean by preferencesStore

  @Preference(exportModeMqtt = true) var keepalive: Int by preferencesStore
  ...
  @Preference(exportModeMqtt = true) var mqttProtocolLevel: MqttProtocolLevel by preferencesStore
  ...
  @Preference(exportModeMqtt = true) var port: Int by preferencesStore

  @Preference var extendedData: Boolean by preferencesStore

  @Preference(exportModeMqtt = true) var pubQos: MqttQos by preferencesStore

  @Preference(exportModeMqtt = true) var pubRetain: Boolean by preferencesStore

  @Preference(exportModeMqtt = true) var pubTopicBase: String by preferencesStore
  ...
  @Preference(exportModeMqtt = true) var sub: Boolean by preferencesStore

  @Preference(exportModeMqtt = true) var subQos: MqttQos by preferencesStore

  @Preference(exportModeMqtt = true) var subTopic: String by preferencesStore

  @Preference var theme: AppTheme by preferencesStore

  @Preference(exportModeMqtt = true) var tls: Boolean by preferencesStore
  ...
  @Preference(exportModeMqtt = false, exportModeHttp = false, exportModeFirestore = false)
  ...
  @Preference(exportModeMqtt = true) var ws: Boolean by preferencesStore
    ...
    return MessageConfiguration()
        ...
        .apply {
          when (mode) {
            ...
            ConnectionMode.FIRESTORE -> firestoreExportedConfigKeys
  ...
  annotation class Preference(
      ...
      val exportModeFirestore: Boolean = true
  )
