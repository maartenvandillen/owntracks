...
import it.vandillen.tracker.di.ApplicationScope
import it.vandillen.tracker.di.CoroutineScopes.IoDispatcher
import it.vandillen.tracker.model.CommandAction
...
import it.vandillen.tracker.model.messages.MessageCmd
import it.vandillen.tracker.model.messages.MessageLocation
import it.vandillen.tracker.model.messages.MessageTransition
import it.vandillen.tracker.model.messages.MessageUnknown
import it.vandillen.tracker.model.messages.MessageWaypoint
import it.vandillen.tracker.net.MessageProcessorEndpoint
import it.vandillen.tracker.net.firestore.FirestoreMessageProcessorEndpoint
import it.vandillen.tracker.net.http.HttpMessageProcessorEndpoint
import it.vandillen.tracker.net.mqtt.MQTTMessageProcessorEndpoint
import it.vandillen.tracker.preferences.DefaultsProvider.Companion.DEFAULT_SUB_TOPIC
  ...
  private fun getEndpoint(mode: ConnectionMode): MessageProcessorEndpoint {
    ...
    return when (mode) {
      ...
      ConnectionMode.FIRESTORE ->
        FirestoreMessageProcessorEndpoint(
            this,
            parser,
            preferences,
            applicationContext,
